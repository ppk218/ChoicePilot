...
const DISCLAIMER_TEXT =
  'Content generated by ChoicePilot is for informational purposes only and is not professional advice.';
...
const ToolsPanel = ({ 
  ...
  return (
    <>
      ...
      <DisclaimerModal
        isOpen={showExportDisclaimer}
        onClose={() => setShowExportDisclaimer(false)}
        onConfirm={exportToPDF}
        text={DISCLAIMER_TEXT}
      />
      <DisclaimerModal
        isOpen={showShareDisclaimer}
        onClose={() => setShowShareDisclaimer(false)}
        onConfirm={() => setActiveTab('share')}
        text={DISCLAIMER_TEXT}
      />
    </>
  );
