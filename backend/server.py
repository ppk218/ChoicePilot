...
# Disclaimer text for exported or shared content
DISCLAIMER_TEXT = (
    "Content generated by ChoicePilot is for informational purposes only and "
...
async def create_decision_share(
    ...
    try:
        ...
        # Attach disclaimer
        share_data["disclaimer"] = DISCLAIMER_TEXT
...
async def get_shared_decision(share_id: str):
    ...
    try:
        ...
        shared_data["disclaimer"] = DISCLAIMER_TEXT
