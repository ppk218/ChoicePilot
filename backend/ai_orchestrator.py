...
{{
  ...
  "confidence_factors": ["Factor 1", "Factor 2"]
    ...
    async def _multi_model_synthesis(
        self, context: str, models: List[str], decision_type: DecisionType
    ) -> DecisionRecommendation:
        """
  ...
  "consensus_notes": "How different model perspectives were integrated"
            ...
            try:
                ...
                return self._parse_synthesis_response(
                    consensus_response, models, decision_type
                )
            except Exception as e:
        ...
        if model_responses:
            ...
            return self._parse_synthesis_response(
                model_responses[best_model], [best_model], decision_type
            )

        return self._generate_fallback_recommendation(context, models, decision_type)

    def _get_model_specific_prompt(
        self, model: str, context: str, decision_type: DecisionType
    ) -> str:
        """
